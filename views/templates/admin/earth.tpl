                            ...
                            <tbody>
                                <tr>
                                    <td align="center">
                                        ...
                                        <table align="center" border="0" bgcolor="#dc2929" class="mlContentTable" cellspacing="0" cellpadding="0" style="background: #dc2929; min-width: 640px; width: 640px;" width="640" id="ml-block-55150241">     
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <table width="640" class="mlContentTable" bgcolor="#dc2929" cellspacing="0" cellpadding="0" border="0" align="center" style="background: #dc2929; width: 640px;">      
                                        ...
                                        <table align="center" border="0" bgcolor="#00D0C0" class="mlContentTable" cellspacing="0" cellpadding="0" style="background: #00D0C0; min-width: 640px; width: 640px;" width="640" id="ml-block-55148251">     
                                            <tbody>
                                                <tr>
                                                    <td> 
                                                        <table width="640" class="mlContentTable" bgcolor="#00D0C0" cellspacing="0" cellpadding="0" border="0" align="center" style="background: #00D0C0; width: 640px;">      
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" class="mlContentContainer" style="padding: 15px 50px 5px 50px; font-family: Helvetica; font-size: 14px; color: #7F8C8D; line-height: 23px;">                           
